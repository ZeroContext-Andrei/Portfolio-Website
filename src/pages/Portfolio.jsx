...
const Portfolio = () => {
  ...
  const handleTabChange = (newTab) => {
    const tabs = ['projects', 'tech-stack', 'certifications'];
    ...
    <PageTransition>
      <div className="min-h-screen text-white py-24 px-6">
        <div className="container mx-auto max-w-7xl">
          ...
          >
            Explore my journey through projects, skills, and achievements.
          </motion.p>

          {/* Tab Navigation */}
          <div className="flex justify-center mb-12">
            <div className="inline-flex bg-gray-800/50 backdrop-blur-sm rounded-full p-1">
              <button
                onClick={() => handleTabChange('projects')}
                className={`px-6 py-2 rounded-full text-sm font-medium transition-colors duration-200 relative ${
                  activeTab === 'projects' ? 'text-white' : 'text-gray-400 hover:text-white'
                }`}
              >
                Projects
                {activeTab === 'projects' && (
              ...
              <button
                ...
                className={`px-6 py-2 rounded-full text-sm font-medium transition-colors duration-200 relative ${
                  activeTab === 'tech-stack' ? 'text-white' : 'text-gray-400 hover:text-white'
                }`}
              >
                Tech Stack
              ...
              <button
                ...
                className={`px-6 py-2 rounded-full text-sm font-medium transition-colors duration-200 relative ${
                  activeTab === 'certifications' ? 'text-white' : 'text-gray-400 hover:text-white'
                }`}
              >
                Certifications
